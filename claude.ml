...
## Project Overview
Daily Dog - Original idea: when new browser tab show picture and some basic info from an API.


**Technology Stack**: Vue 3 / Vite / Tailwind CSS / Netlify proxy function if sensitive API keys
